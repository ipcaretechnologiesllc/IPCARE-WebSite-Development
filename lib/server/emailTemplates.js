...
export function tplContactRentalAutoReply({ name }) {
  const firstName = E((name || '').split(' ')[0] || name || '')
  const subject = 'Rental enquiry received, IP Care Technologies'
  const body = `
    <h2 style="margin:0 0 12px;color:#0F245F;font-size:20px;">Thanks${firstName ? ', ' + firstName : ''}, we've got your rental enquiry.</h2>
    <p>Our rental team will review your requirements and reply within <b style="color:#E87722;">4 business hours</b> (UAE 09:00-18:00, Canada 09:00-17:00) with availability, pricing, and a tailored quote.</p>
    <p>If your event or project is time-critical, please call us directly:</p>
    <ul style="padding-left:18px;">
      <li>UAE: <a href="tel:+97126766935" style="color:#E87722;text-decoration:none;">+971 2 676 6935</a></li>
      <li>Canada: <a href="tel:+14167860782" style="color:#E87722;text-decoration:none;">+1 416 786 0782</a></li>
    </ul>
    <p>While you wait, browse our full rental catalogue at <a href="https://www.ipcare.ae/rental" style="color:#E87722;text-decoration:none;">www.ipcare.ae/rental</a>, many of the most-requested items are in stock and ready to ship across UAE and Canada.</p>
    <p style="margin-top:24px;color:#6b7280;font-size:13px;">, The IP Care Rental Team</p>
  `
  return { subject, html: wrap(body, { preheader: 'Rental enquiry received. Reply within 4 business hours.' }) }
}
