  ...
  'cloud': {
    ...
    subpages: {
      'migration': {
        ...
        heroImage: 'https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=900&q=85',
        heroImageAlt: 'Enterprise data centre server racks — IP Care Technologies cloud migration UAE',
        sectionImage: 'https://images.unsplash.com/photo-1605745341112-85968b19335b?w=900&q=85',
        sectionImageAlt: 'Modern data centre corridor with fibre optic cabling — IP Care Technologies',
        sectionContent: {
      ...
      'microsoft-365': {
        ...
        heroImageAlt: 'Microsoft 365 setup, security and management for UAE businesses',
        ...
        overview: [
          'Microsoft 365 Services UAE organisations actually need go well beyond buying licences. Most tenants we review have the same three problems: they are paying for licence tiers they do not use (E3 seats where Business Premium would do, or Business Basic where they actually need E5 Compliance), they have never configured Conditional Access or MFA, and they believe Microsoft is backing up their data. It is not.',
        ...
        faqs: [
          ...
          { q: 'Can you migrate us from Google Workspace or on-prem Exchange?', a: 'Yes. We migrate from Google Workspace (Gmail, Drive, Calendar, Contacts), on-prem Exchange (2010 through 2019), other M365 tenants and a range of other mail systems. The approach depends on your source platform, mailbox count and downtime tolerance — all of which we establish during the assess phase before any migration work starts.' },
