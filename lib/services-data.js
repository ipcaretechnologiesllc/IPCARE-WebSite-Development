...
export const serviceCategories = {
  'it-consulting': {
    ...
    subpages: {
      'technology-strategy': {
        ...
        h1: 'IT Technology Strategy in UAE',
      ...
      'it-assessment': {
        ...
        h1: 'IT Assessment & Planning Services in UAE',
      ...
      'digital-transformation': {
        ...
        h1: 'Digital Transformation Services in UAE',
  ...
  'infrastructure': {
    ...
    subpages: {
      'data-centre-management': {
        ...
        h1: 'Data Centre Management Services in UAE',
      ...
      'virtualization': {
        ...
        h1: 'Virtualization Solutions in UAE',
      ...
      'hardware-procurement': {
        ...
        h1: 'IT Hardware Procurement in UAE',
  ...
  'elv': {
    ...
    subpages: {
      ...
      'access-control': {
        ...
        h1: 'Access Control Systems in UAE',
      ...
      'gate-barriers': {
        ...
        h1: 'Automatic Gate Barrier Systems in UAE',
      ...
      'public-address-systems': {
        ...
        h1: 'Public Address (PA) Systems in UAE',
      ...
      'intercom-systems': {
        ...
        h1: 'Audio & Video Intercom Systems in UAE',
      ...
      'structured-cabling': {
        ...
        h1: 'Structured Cabling Services in UAE',
  ...
  'managed-it': {
    ...
    subpages: {
      'network-management': {
        ...
        h1: 'Network Management Services in UAE',
      ...
      'server-management': {
        ...
        h1: 'Server Management Services in UAE',
      ...
      'it-support-helpdesk': {
        ...
        h1: 'IT Support & Helpdesk in Abu Dhabi',
      ...
      'sla': {
        ...
        h1: 'IT Service Level Agreements in UAE',
  ...
  'cloud': {
    ...
    subpages: {
      'migration': {
        ...
        h1: 'Cloud Migration Services in UAE',
      ...
      'microsoft-365': {
        ...
        h1: 'Microsoft 365 Services in UAE',
      ...
      'backup-recovery': {
        ...
        h1: 'Data Backup & Recovery in UAE',
      ...
      'microsoft-entra-id': {
        ...
        title: 'Microsoft Entra ID Services UAE — Identity & Access Management | IP Care Technologies',
        metaDescription: 'Microsoft Entra ID (Azure AD) services in UAE. SSO, MFA, Conditional Access, PIM, identity governance and hybrid identity for cloud security.',
        h1: 'Microsoft Entra ID Services UAE',
        hero: 'Secure every identity, everywhere — with Microsoft Entra ID.',
        overview: [
          'Identity is the new perimeter. Microsoft Entra ID (formerly Azure Active Directory) is the foundation for Zero Trust security across your cloud and on-premise estate.',
          'IP Care delivers end-to-end Entra ID implementations — from basic Single Sign-On and Multi-Factor Authentication to advanced Conditional Access policies, Privileged Identity Management (PIM) and Identity Governance.',
          'Our Microsoft-certified engineers design hybrid identity solutions that sync on-premise Active Directory with Entra ID, integrate with Microsoft 365, Azure and third-party SaaS applications, and enforce compliance with UAE PDPL and NESA identity security requirements.',
        ],
        features: [
          { icon: 'KeyRound', title: 'Single Sign-On (SSO)', desc: 'One identity across all business applications — Microsoft 365, Azure, Salesforce, Workday and 3,000+ pre-integrated SaaS apps.' },
          { icon: 'ShieldCheck', title: 'Multi-Factor Authentication', desc: 'Deploy and enforce MFA policies across all users with passwordless authentication options.' },
          { icon: 'Settings', title: 'Conditional Access Policies', desc: 'Control who accesses what, from where, on which device with risk-based authentication policies.' },
          { icon: 'UserCog', title: 'Identity Governance', desc: 'Automated access reviews, entitlement management and lifecycle workflows for joiner/mover/leaver processes.' },
          { icon: 'Crown', title: 'Privileged Identity Management', desc: 'Just-in-time privileged access with approval workflows and time-limited elevation for admin roles.' },
          { icon: 'Network', title: 'Hybrid Identity', desc: 'Sync on-premise Active Directory with Microsoft Entra ID for seamless hybrid operations.' },
        ],
        benefits: [
  ...
  'cybersecurity': {
    ...
    subpages: {
      'security-assessment': {
        ...
        h1: 'Security Assessment Services in UAE',
      ...
      'incident-response': {
        ...
        h1: 'Incident Response Services in UAE',
      ...
      'compliance': {
        ...
        h1: 'Cybersecurity Compliance in UAE',
      ...
      'endpoint-protection': {
        ...
        h1: 'Endpoint Protection Services in UAE',
      ...
      'pam': {
        ...
        h1: 'Privileged Access Management in UAE',
      ...
      'email-security': {
        ...
        h1: 'Email Security Services in UAE',
      ...
      'microsoft-entra-id': {
        ...
        h1: 'Microsoft Entra ID Services in UAE',
        hero: 'Secure every identity, everywhere — with Microsoft Entra ID.',
        overview: [
  ...
  'web-development': {
    ...
    icon: 'Code',
    short: 'Custom websites, eCommerce, apps',
    keyword: 'Web Development UAE',
    title: 'Web Development UAE — Custom Websites, eCommerce, Apps | IP Care Technologies',
    metaDescription: 'Enterprise web development in UAE. Custom websites, eCommerce platforms and mobile apps built with modern frameworks, hosted on UAE-residency cloud.',
    h1: 'Web Development Services in UAE',
    hero: 'Modern web and mobile experiences — fast, accessible, on-brand.',
    overview: [
      'Your digital presence is often the first touchpoint a customer has with your brand. IP Care builds websites, eCommerce platforms and mobile apps that convert, scale and last.',
      'We specialise in modern frameworks — Next.js, React, Vue, Node.js, Laravel — and headless CMS (Strapi, Sanity, Contentful) for content agility.',
      'Every project includes SEO foundation, Core Web Vitals optimisation, WCAG accessibility and UAE-compliant hosting options.',
    ],
    features: [
      { icon: 'Code', title: 'Custom Websites', desc: 'Bespoke corporate sites, marketing portals and digital experiences.' },
      { icon: 'ShoppingBag', title: 'eCommerce', desc: 'Shopify Plus, Magento, Salesforce Commerce and headless eCommerce builds.' },
      { icon: 'Smartphone', title: 'App Development', desc: 'iOS, Android and cross-platform apps with React Native and Flutter.' },
    ],
    benefits: [
      { icon: 'Gauge', t: 'Sub-1s load time', d: 'Core Web Vitals optimised for Google ranking.' },
      { icon: 'Search', t: 'SEO from day one', d: 'Technical SEO, schema markup, canonical URLs baked in.' },
      { icon: 'Globe', t: 'Global + RTL', d: 'Multi-language and Arabic RTL support.' },
      { icon: 'ShieldCheck', t: 'Secure by design', d: 'OWASP Top 10, WAF and DDoS mitigation.' },
    ],
    process: [
      { n: '01', t: 'Discover', d: 'Goals, audience, competitive review, IA.' },
      { n: '02', t: 'Design', d: 'UX wireframes, visual design, prototyping.' },
      { n: '03', t: 'Build', d: 'Agile development, QA, security testing.' },
      { n: '04', t: 'Launch & Grow', d: 'Go-live, SEO, analytics, ongoing improvements.' },
    ],
    industries: ['Retail', 'Hospitality', 'Government', 'Real Estate', 'Finance', 'Education'],
    faqs: [
      { q: 'Do you build on WordPress or custom frameworks?', a: 'Both. We recommend WordPress for content-heavy sites, Next.js/React for complex applications, and Shopify/Magento for commerce — based on your needs.' },
      { q: 'Can you host in the UAE?', a: 'Yes. We host on AWS Middle East, Azure UAE North and local providers as required for data residency.' },
      { q: 'Do you support Arabic RTL?', a: 'Every project ships with bi-directional layout support and Arabic-first design review if required.' },
    ],
    subpages: {
      'custom-websites': {
        keyword: 'Custom Website Development UAE',
        title: 'Custom Website Development UAE | IP Care Technologies',
        metaDescription: 'Bespoke custom website development in UAE. Next.js, React and headless CMS builds with SEO, Arabic RTL and Core Web Vitals optimisation.',
        h1: 'Custom Website Development in UAE',
        hero: 'Bespoke corporate websites engineered for performance and growth.',
        overview: [
          'Every serious brand deserves a website that reflects its ambition. Off-the-shelf templates rarely achieve that.',
          'IP Care builds custom websites on Next.js, React and headless CMS — with design, content strategy, SEO and analytics integrated from day one.',
          'We support Arabic RTL, multi-language, accessibility (WCAG 2.2 AA) and UAE-resident hosting.',
        ],
      },
      'ecommerce': {
        keyword: 'eCommerce Development UAE',
        title: 'eCommerce Development UAE — Shopify, Magento, Headless | IP Care Technologies',
        metaDescription: 'eCommerce development in UAE. Shopify Plus, Magento, Salesforce Commerce and headless commerce builds with UAE payment gateways.',
        h1: 'eCommerce Development in UAE',
        hero: 'Commerce platforms that convert — from storefront to ERP.',
        overview: [
          'eCommerce success depends on speed, search, trust and a frictionless checkout. We build on the platforms best suited to each — Shopify Plus, Magento, Salesforce Commerce Cloud, and custom headless stacks.',
          'Every build integrates UAE payment gateways (Telr, Network International, PayTabs, Tabby, Tamara, Apple Pay, Google Pay).',
          'Ongoing conversion-rate optimisation (CRO) and A/B testing are available as a managed service.',
        ],
      },
      'app-development': {
        keyword: 'Mobile App Development UAE',
        title: 'Mobile App Development UAE — iOS, Android, React Native | IP Care Technologies',
        metaDescription: 'Mobile app development in UAE. Native iOS, Android and cross-platform React Native and Flutter apps with backend integration.',
        h1: 'Mobile App Development in UAE',
        hero: 'Native and cross-platform mobile apps — from prototype to app store.',
        overview: [
          'A great mobile app is both a product and a business. IP Care builds apps that delight users and perform against defined KPIs.',
          'We deliver native iOS (Swift) and Android (Kotlin) apps, as well as cross-platform apps on React Native and Flutter.',
          'Services include UX design, backend APIs, app store submission (with Arabic and UAE localisation), analytics and crash reporting.',
        ],
      },
    },
  },
  ...
  'digital-marketing': {
    ...
    icon: 'TrendingUp',
    short: 'SEO, SEM, social media',
    keyword: 'Digital Marketing UAE',
    title: 'Digital Marketing UAE — SEO, SEM, Social Media | IP Care Technologies',
    metaDescription: 'Performance-driven digital marketing in UAE. SEO, SEM, paid social and content marketing aligned to pipeline and revenue goals.',
    h1: 'Digital Marketing Services in UAE',
    hero: 'Performance marketing that moves pipeline — not just vanity metrics.',
    overview: [
      'Marketing without measurement is folklore. IP Care runs performance-driven digital marketing for UAE enterprise and SME clients.',
      'Our team blends technical SEO, paid media, creative and analytics — all tied to defined business outcomes (leads, qualified meetings, revenue).',
      'We operate across Google, Meta, LinkedIn, TikTok and emerging regional platforms, with monthly performance reviews and transparent reporting.',
    ],
    features: [
      { icon: 'Search', title: 'Search Engine Optimization', desc: 'Technical, on-page and content SEO for Google and Bing.' },
      { icon: 'MousePointerClick', title: 'Search Engine Marketing', desc: 'Google Ads, Bing Ads and programmatic display for demand capture.' },
      { icon: 'Share2', title: 'Social Media', desc: 'Organic and paid social across Meta, LinkedIn, TikTok, X and Snap.' },
    ],
    benefits: [
      { icon: 'LineChart', t: 'Pipeline transparency', d: 'Full funnel attribution from ad-click to closed deal.' },
      { icon: 'Target', t: 'Lower CAC', d: 'Ongoing optimisation reduces cost per acquisition month over month.' },
      { icon: 'Globe', t: 'Bilingual campaigns', d: 'Arabic and English creative tuned for UAE audiences.' },
      { icon: 'ClipboardList', t: 'Executive reporting', d: 'Dashboards CFOs and CEOs actually read.' },
    ],
    process: [
      { n: '01', t: 'Audit', d: 'SEO, paid, analytics and competitive benchmarking.' },
      { n: '02', t: 'Strategy', d: 'Channel mix, messaging, offer and budget model.' },
      { n: '03', t: 'Execute', d: 'Campaign build, creative, launch, tests.' },
      { n: '04', t: 'Optimise', d: 'Weekly sprints, monthly reviews, quarterly re-strategy.' },
    ],
    industries: ['Retail', 'Hospitality', 'Real Estate', 'B2B Tech', 'Healthcare', 'Education'],
    faqs: [
      { q: 'Do you work with smaller budgets?', a: 'Yes. We have packages starting from AED 15k/month. We are transparent about what a given budget can and cannot achieve.' },
      { q: 'Do you do Arabic creative?', a: 'Yes. All our creative team are bilingual and we culturally localise (not just translate) for GCC audiences.' },
      { q: 'How long before we see SEO results?', a: 'Paid channels drive results in days; SEO typically shows meaningful movement in 3–6 months for competitive keywords.' },
    ],
    subpages: {
      'seo': {
        keyword: 'SEO Services UAE',
        title: 'SEO Services UAE — Technical, On-Page, Content SEO | IP Care Technologies',
        metaDescription: 'Enterprise SEO services in UAE. Technical, on-page and content SEO for Google and Bing. Arabic and English optimisation with measurable results.',
        h1: 'SEO Services in UAE',
        hero: 'Rank, convert, compound — enterprise SEO for the UAE market.',
        overview: [
          'SEO is the best compounding marketing investment you can make. Every ranked page keeps delivering traffic long after it is published.',
          'IP Care runs technical, on-page and content SEO for UAE clients — from competitive retail to niche B2B.',
          'We are transparent about what SEO can deliver and in what timeframe, and we never buy links.',
        ],
      },
      'sem': {
        keyword: 'SEM / Google Ads UAE',
        title: 'SEM & Google Ads UAE — Paid Search Management | IP Care Technologies',
        metaDescription: 'Google Ads and paid search management in UAE. Campaign strategy, build, optimisation and ROAS-driven paid media management.',
        h1: 'SEM & Paid Search Management in UAE',
        hero: 'Google Ads that pay for themselves — run by certified experts.',
        overview: [
          'Paid search is the fastest route to qualified demand. Done badly, it is a cash furnace.',
          'IP Care runs performance Google Ads, Microsoft Ads and programmatic campaigns across UAE, GCC and international targets.',
          'All accounts are managed in-house (not offshored) with weekly optimisation and monthly ROAS-based reviews.',
        ],
      },
      'social-media': {
        keyword: 'Social Media Marketing UAE',
        title: 'Social Media Marketing UAE — Meta, LinkedIn, TikTok | IP Care Technologies',
        metaDescription: 'Social media marketing in UAE. Organic and paid social strategy, creative, community management and performance reporting.',
        h1: 'Social Media Marketing in UAE',
        hero: 'Social strategies that build brand and pipeline — not just followers.',
        overview: [
          'Social media in the UAE is one of the highest-engagement markets in the world — if your content earns the scroll.',
          'IP Care delivers organic and paid social across Meta (Facebook/Instagram), LinkedIn, TikTok, X, Snapchat and YouTube.',
          'Services include strategy, creative production, community management, paid amplification and influencer partnerships.',
        ],
      },
    },
  },
  ...
  'email-solutions': {
    ...
    subpages: {
      'google-workspace': {
        ...
        h1: 'Google Workspace Services in UAE',
      ...
      'microsoft-365': {
        ...
        h1: 'Microsoft 365 for Business in UAE',
      ...
      'email-hosting': {
        ...
        h1: 'Professional Email Hosting in UAE',
      ...
      'hybrid': {
        ...
        h1: 'Hybrid Email Solutions in UAE',
