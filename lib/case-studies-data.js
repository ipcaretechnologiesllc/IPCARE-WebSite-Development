...
export const narrativeCaseStudies = [
  {
    ...
    ogTitle: 'Stolen in a session, not in a password — incident response case study',
    ogDescription:
    ...
    challenge: {
      ...
      items: [
        ...
        },
        {
          ...
          text: 'Profile data was changed by automated tooling running through fabricated or replayed device profiles — with no failed logins to trace.',
        },
        {
