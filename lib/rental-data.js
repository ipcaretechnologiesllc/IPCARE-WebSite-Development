...
export const rentalCategories = {
  ...
  'cctv': {
    ...
    metaDescription: 'CCTV and security camera rental in UAE. IP cameras, NVRs, PTZ, thermal. Fully deployed with live monitoring, SIRA-licensed (Dubai) and ADMCC-certified (Abu Dhabi) install.',
    description: 'Rapid-deploy CCTV kits — cameras, NVRs, analytics — with on-site command centre, SIRA-licensed and ADMCC-certified installation.',
    products: [
