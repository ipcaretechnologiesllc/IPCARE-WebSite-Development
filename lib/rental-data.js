...
const SWITCH_IMG = 'https://images.unsplash.com/photo-1544197150-b99a580bb7a8'
...
export const rentalCategories = {
  ...
  'event-wifi': {
    ...
    products: [
      P('aruba-ap-635-wifi6e', 'HPE Aruba', 'AP-635 WiFi 6E', ['Tri-band 6 GHz WiFi 6E', 'Up to 3.9 Gbps per radio', '1,024 concurrent clients'], { Standard: 'WiFi 6E (802.11ax)', Bands: '2.4/5/6 GHz', MaxThroughput: '7.8 Gbps aggregate', Clients: '1,024 concurrent', PoE: '802.3bt', Antennas: '4×4:4 internal' }, { daily: 95, weekly: 480, monthly: 1400 }, 'https://images.unsplash.com/photo-1606904825846-647eb07f5be2?w=600&q=80'),
      P('meraki-mr57', 'Cisco Meraki', 'MR57 WiFi 6E', ['Cloud-managed WiFi 6E', '8-stream 6 GHz radio', 'Bluetooth 5 LE beacon'], { Standard: 'WiFi 6E', Radios: '4 (2.4/5/6 GHz + scanning)', Streams: '8×8:8 on 5/6 GHz', MaxThroughput: '10.75 Gbps', Management: 'Meraki cloud dashboard' }, { daily: 105, weekly: 520, monthly: 1550 }, 'https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=600&q=80'),
      P('ruckus-r770-wifi7', 'Ruckus', 'R770 WiFi 7', ['First WiFi 7 AP in region', 'BeamFlex+ adaptive antenna', 'Up to 22 Gbps aggregate'], { Standard: 'WiFi 7 (802.11be)', MaxThroughput: '22 Gbps', Antenna: 'BeamFlex+ adaptive', PoE: '802.3bt Type 4', Management: 'RUCKUS One cloud / SmartZone' }, { daily: 140, weekly: 720, monthly: 2100 }, 'https://images.unsplash.com/photo-1616763355548-1b606f439f86?w=600&q=80'),
      P('cisco-mx85', 'Cisco Meraki', 'MX85 Security Appliance', ['2 Gbps firewall throughput', '10G SFP+ uplink', 'Auto VPN + SD-WAN'], { Throughput: '2 Gbps firewall', VPN: '1 Gbps IPsec', Ports: '10× 1GbE + 2× 10GbE SFP+', Users: 'Up to 500', Failover: 'Dual WAN + LTE' }, { daily: 130, weekly: 650, monthly: 1900 }, 'https://images.unsplash.com/photo-1563986768609-322da13575f3?w=600&q=80'),
      P('ubiquiti-udm-pro-max', 'Ubiquiti', 'UniFi Dream Machine Pro Max', ['10G SFP+ uplink', 'Integrated controller', '750+ client capacity'], { Throughput: '5 Gbps', Storage: '2× 3.5" HDD bays for protect', Ports: '8× 1GbE + 2× 10GbE SFP+', Users: '750+' }, { daily: 75, weekly: 390, monthly: 1150 }, 'https://images.unsplash.com/photo-1544197150-b99a580bb7a8?w=600&q=80'),
      P('peplink-balance-two', 'Peplink', 'Balance Two (SD-WAN)', ['Dual SIM 5G SD-WAN', 'Link aggregation', 'Ideal for events'], { Throughput: '1 Gbps', Cellular: 'Dual 5G SIM', SD_WAN: 'SpeedFusion', Ports: '4× 1GbE WAN + 1× 1GbE LAN', Failover: 'Multi-WAN hot failover' }, { daily: 95, weekly: 470, monthly: 1350 }, 'https://images.unsplash.com/photo-1695668548342-c0c1ad479aee?w=600&q=80'),
    ],
  },
  'networking': {
