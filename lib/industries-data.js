...
export const industries = {
  'healthcare': {
    ...
    metaDescription: 'Healthcare IT services across the UAE — DOH-aligned hospital systems, DHA-compliant clinic IT, Malaffi and NABIDH integration, medical device security and 24/7 clinical support.',
    h1: 'Healthcare IT Services in the UAE',
    hero: 'Hospital and clinic IT that does not fail during a shift — DOH and DHA-aligned, Malaffi and NABIDH integrated, with 24/7 operational support that clinical teams can actually call.',
    overview: [
    ...
    regulatoryFramework: [
      ...
      { name: 'DOH Abu Dhabi standards', scope: 'Clinical standards, facility accreditation, Malaffi integration mandate.' },
      { name: 'DHA Dubai standards', scope: 'Clinical standards, facility licensing, NABIDH integration mandate.' },
      { name: 'Malaffi (Abu Dhabi HIE)', scope: 'Unified health information exchange — mandatory for licensed facilities.' },
      { name: 'NABIDH (Dubai HIE)', scope: 'Dubai Health Authority health information exchange.' },
    ...
    serviceHooks: [
      ...
      { title: 'HIE Integration (Malaffi & NABIDH)', desc: 'Continuous integration with Malaffi (Abu Dhabi) and NABIDH (Dubai). ADT, lab, radiology and pharmacy event flows.', href: '/services/managed-it/network-management', icon: 'Network' },
  ...
  'banking': {
    ...
    title: 'Banking IT UAE — CB IBR, DFSA, Payment Systems, SOC | IP Care Technologies',
    metaDescription: 'Banking IT services across UAE — CB IBR-compliant cloud and SOC, DFSA cyber risk management, payment systems integration, FATF-aligned security for licensed banks and financial services firms.',
    h1: 'Banking & Financial Services IT in the UAE',
    hero: 'Banking IT that the Central Bank, DFSA and FSRA can sign off on — CB IBR-aligned operations, payment systems integration and a managed SOC that actually catches threats during business hours.',
    overview: [
    ...
    regulatoryFramework: [
      { name: 'UAE Central Bank IBR', scope: 'Information Security Regulation — licensed banks and payment-services providers under Central Bank oversight.' },
      { name: 'DFSA Cyber Risk Management', scope: 'Module for DIFC-regulated firms — risk management, incident response, third-party risk.' },
      { name: 'FSRA Cyber Rules', scope: 'Cyber rules for ADGM-regulated firms — broadly parallel to DFSA.' },
    ...
    serviceHooks: [
      { title: 'Managed SOC for Banking', desc: 'XSIAM or Sentinel SIEM with banking-tuned use cases, incident reporting templates aligned to Central Bank timing, 24/7 analyst coverage.', href: '/services/cybersecurity/abu-dhabi', icon: 'ShieldCheck' },
      { title: 'CB IBR-Compliant Cloud', desc: 'Azure UAE North or AWS Middle East UAE landing zones with residency, audit-logging, segmentation and third-party controls built in.', href: '/services/cloud/abu-dhabi', icon: 'Cloud' },
      { title: 'Identity & Access for Banking', desc: 'Microsoft Entra ID with Conditional Access, PIM, MFA and identity governance — pass DFSA and Central Bank scrutiny at audit.', href: '/services/cybersecurity/microsoft-entra-id', icon: 'KeyRound' },
    ...
    proof: [
      ...
      { stat: 'CB IBR', label: 'Standard practice, not retrofit' },
      { stat: '100M+ users', label: 'Cybersecurity practice protected to date' },
      { stat: '20+ years', label: 'UAE financial services delivery history' },
    ],
    faqs: [
      { q: 'Do you build CB IBR-compliant cloud landing zones?', a: 'Yes. The CB IBR control set is integrated into the landing zone reference architecture — residency, audit-logging, segmentation, identity, third-party risk — and validated as part of the build, not retrofitted after migration. Azure UAE North is the typical primary region; AWS Middle East UAE is the alternative for AWS-anchored portfolios.' },
      ...
      { q: 'How do you handle Central Bank incident reporting?', a: 'Central Bank incident reporting timing is part of the SOC runbook. Detection and triage happen on the standard SOC clock; reporting follows the Central Bank framework. The evidence pack and post-incident analysis are written for the regulator audience, not just internal stakeholders.' },
      { q: 'Do you work with DIFC and ADGM firms?', a: 'Yes. DFSA Cyber Risk Management Module work for DIFC firms and FSRA cyber rules work for ADGM firms are regular parts of our scope. The two frameworks parallel each other and parallel CB IBR with material overlap, so the underlying operating model translates across the three regimes.' },
      { q: 'Can you handle PCI-DSS for card environments?', a: 'Yes. PCI-DSS environment isolation, audit logging, vulnerability management and quarterly attestation are part of the standard scope for clients with card-processing environments. The integration with the broader CB IBR or DFSA control set means a single operating model satisfies both.' },
      { q: 'Are you cheap?', a: 'No. We are not the cheapest banking IT vendor in the region and we do not pretend to be. We are also the vendor that has not had a client receive a Central Bank or DFSA P1 enforcement notice post-engagement. Banks that have been through regulator enforcement understand why those two statements are connected.' },
    ],
  },
  ...
  'government': {
    ...
    regulatoryFramework: [
      ...
      { name: 'TDRA', scope: 'Telecommunications and Digital Government Regulatory Authority — digital government framework.' },
      { name: 'FAHR personnel security', scope: 'Federal Authority for Government Human Resources — clearance framework for cleared roles.' },
      ...
      { name: 'Sector overlays', scope: 'Federal energy (ADNOC ecosystem), federal banking, federal health, federal defence-adjacent.' },
    ],
    serviceHooks: [
    ...
    faqs: [
      ...
      { q: 'Are your engineers cleared?', a: 'For cleared roles in federal engagements, our operating teams hold the relevant clearance and the operational familiarity with the FAHR personnel security framework. We do not staff cleared roles with uncleared engineers and we do not transfer cleared engineers between unrelated engagements.' },
