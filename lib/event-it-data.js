...
export const subpages = {
  ...
  'event-cctv': {
    ...
    overview: [
      ...
      'Compliant with SIRA (Dubai) and ADMCC (Abu Dhabi) requirements, with event-day coordination across security, operations and broadcast teams.',
    ],
    features: [
    ...
    benefits: [
      ...
      { icon: 'ClipboardCheck', t: 'Regulatory ready', d: 'SIRA and ADMCC aligned with retention and export compliance.' },
