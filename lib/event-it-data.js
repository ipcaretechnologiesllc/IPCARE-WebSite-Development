...
export const events = [
  {
    ...
    endDate: '2022-02-12',
    rightsHolder: { type: 'Organization', name: 'FIFA' },
  },
  {
    slug: 'ufc-uae',
    ...
    stats: { users: 'Up to 18K per fight night', sites: 'Etihad Arena, Yas Bay', duration: '20 fight cards, 2020-2026' },
    img: '/events/ufc-uae.webp',
    imgPos: 'center 55%',
    startDate: '2020-07-11', // confirmed: UFC 251 "Fight Island" first event Jul 11, 2020
    endDate: '2026-07-25',   // latest delivered: UFC Fight Night: Ankalaev vs. Guskov, Jul 25, 2026
    rightsHolder: { type: 'Organization', name: 'UFC' },
  },
  {
    ...
    endDate: '2021-12-21',
    rightsHolder: { type: 'Organization', name: 'World Aquatics (FINA)' },
  },
  {
    ...
    rightsHolder: { type: 'Organization', name: 'NBA' },
  },
  {
    ...
    endDate: '2022-05-07',
    rightsHolder: { type: 'Organization', name: 'World Boxing Association (WBA)' },
  },
  {
    slug: 'world-tennis-league',
    name: 'World Tennis League',
    year: '2022, 2023',
    location: 'Coca-Cola Arena, Dubai (2022) & Etihad Arena, Abu Dhabi (2023)',
    region: 'UAE Events',
    category: 'Sports',
    tech: 'Arena WiFi, Hawk-Eye integration network, broadcast LAN, on-court connectivity',
    stats: { users: '15K+ per night', sites: 'Coca-Cola Arena & Etihad Arena', duration: '2 editions' },
    img: '/events/world-tennis-league.webp',
    imgPos: 'center 55%',
    startDate: '2022-12-19', // confirmed: 2022 edition Dec 19-24, Coca-Cola Arena Dubai
    endDate: '2023-12-24',   // confirmed: 2023 edition Dec 21-24, Etihad Arena Abu Dhabi
  },
  {
  ...
  },
  {
    ...
    endDate: '2025-05-25',
    rightsHolder: { type: 'Organization', name: 'EuroLeague' },
  },
  {
    slug: 'euroleague-supercup-2026',
    name: 'EuroLeague Basketball SuperCup Abu Dhabi 2026',
    year: '2026',
    location: 'Etihad Arena, Yas Island, Abu Dhabi',
    region: 'UAE Events',
    category: 'Sports',
    tech: 'Arena WiFi 6E, broadcast LAN, EuroLeague timing and statistics integration, NOC operations',
    stats: { users: 'Real Madrid, Olympiacos, Fenerbahce, Dubai Basketball', sites: 'Etihad Arena', duration: 'September 18-19, 2026' },
    img: '/events/euroleague-supercup-2026-team.webp',
    startDate: '2026-09-18', // confirmed: Etihad Arena event listing, 18-19 September 2026
    endDate: '2026-09-19',
    rightsHolder: { type: 'Organization', name: 'EuroLeague Basketball' },
  },
  {
  ...
  },
  {
    ...
    rightsHolder: { type: 'Organization', name: 'USA Basketball' },
  },
  {
  ...
  },
  {
    ...
    rightsHolder: { type: 'Organization', name: 'International Indian Film Academy (IIFA)' },
  },
  {
  ...
  },
  {
    ...
    region: 'UAE Events',
    category: 'Concerts',
    tech: 'Open-air venue WiFi, PtP microwave uplinks, CCTV, multi-stage segmentation, on-site iPad deployment',
  ...
  },
  {
    ...
    endDate: '2024-01-15',
    rightsHolder: { type: 'MusicGroup', name: 'Coldplay' },
  },
]
  ...
  'event-wifi': {
    ...
    sectionContent: {
      checklist: [
        ...
        { label: 'Smaller meeting or short-notice booking instead? See self-serve Event WiFi rental', href: '/rental/event-wifi' },
      ],
    },
    faqs: [
      ...
      { q: 'Do you offer a smaller or short-notice event WiFi option?', a: 'Yes. For a single meeting room, a small conference or a booking without the lead time a full RF survey needs, see our self-serve event WiFi rental — access points and routers priced and shippable directly, without the full managed-deployment scope this page describes.' },
    ],
  },
...
subpages['ufc-uae'] = {
  ...
  title: 'UFC in the UAE (2020-2026): Event IT for 20 Fight Cards | IP Care',
  metaDescription: 'How IP Care delivered the network, production LAN and security infrastructure behind all 20 UFC events in the UAE from Fight Island 2020 to UFC Fight Night: Ankalaev vs. Guskov in July 2026.',
  h1: 'UFC in the UAE (2020-2026): Six Years of Pay-Per-View IT, One Operating Model',
  h1Accent: 'UFC',
  hero: 'How IP Care has delivered arena WiFi, live production LAN, broadcast uplinks and security operations for every UFC event on Yas Island since 2020, from Fight Island to UFC Fight Night: Ankalaev vs. Guskov at Etihad Arena in July 2026.',
  icon: 'Zap',
  overview: [
    ...
    'UFC in the UAE has been the opposite. What began in 2020 as a COVID-era bubble, a self-contained event environment on Yas Island while most of global sport was shut down, has run continuously for six years and 20 fight cards. Same venue family. Same broadcast partners. Same operating expectations. Same IT delivery team. Many of the engineers on the floor for UFC Fight Night: Ankalaev vs. Guskov in July 2026 were on the floor in 2020. That continuity is unusual in event work and it is the single most important factor in why the operation runs the way it does.',
    'This case study walks through the technical architecture, the operating model and what changed year-over-year across the six-year run. The full list of UFC events we have delivered in the UAE follows the overview.',
    'The brief',
    ...
    'The latest card: July 2026',
    'UFC Fight Night: Ankalaev vs. Guskov at Etihad Arena on 25 July 2026 was the 20th UFC event we have delivered in the UAE, and the first of the 2026 season. The card changed late: the original headliner withdrew injured and Bogdan Guskov stepped in against Magomed Ankalaev, with further bout changes through fight week. Late card changes are what the validate-every-event model is built to absorb: the network underneath is already proven, so fight-week effort goes into re-checking against the revised card rather than rebuilding. The five-round main event went to air on the same operating model that has carried every UFC card on Yas Island since 2020.',
    'The kit',
    ...
    'There has been a recurring theme across the six years of small, undramatic issues caught early because the operating discipline runs deep. None of them have surfaced as event-day incidents. That is the deliverable.',
    'What works',
  ...
  // Every UFC event held in the UAE since 2020, all delivered by IP Care
  // (confirmed by the client 2026-09-23). Dates are UFC's official event dates
  // (ufc.com); 2020 Fight Island cards ran at du Forum, everything since at
  // Etihad Arena. Add new cards to the top year group as they happen.
  eventTimeline: {
    eyebrow: 'Delivery Record',
    heading: 'Every UFC Event in the UAE Since 2020',
    intro: '20 fight cards on Yas Island, all delivered by IP Care, from the first Fight Island event in July 2020 to the latest night at Etihad Arena.',
    groups: [
      { year: '2026', items: [
        { name: 'UFC Fight Night: Ankalaev vs. Guskov', date: '25 Jul 2026', venue: 'Etihad Arena', latest: true },
      ] },
      { year: '2025', items: [
        { name: 'UFC 321: Aspinall vs. Gane', date: '25 Oct 2025', venue: 'Etihad Arena' },
        { name: 'UFC Fight Night: Whittaker vs. de Ridder', date: '26 Jul 2025', venue: 'Etihad Arena' },
      ] },
      { year: '2024', items: [
        { name: 'UFC 308: Topuria vs. Holloway', date: '26 Oct 2024', venue: 'Etihad Arena' },
        { name: 'UFC Fight Night: Sandhagen vs. Nurmagomedov', date: '3 Aug 2024', venue: 'Etihad Arena' },
      ] },
      { year: '2023', items: [
        { name: 'UFC 294: Makhachev vs. Volkanovski 2', date: '21 Oct 2023', venue: 'Etihad Arena' },
      ] },
      { year: '2022', items: [
        { name: 'UFC 280: Oliveira vs. Makhachev', date: '22 Oct 2022', venue: 'Etihad Arena' },
      ] },
      { year: '2021', items: [
        { name: 'UFC 267: Błachowicz vs. Teixeira', date: '30 Oct 2021', venue: 'Etihad Arena' },
        { name: 'UFC 257: Poirier vs. McGregor 2', date: '23 Jan 2021', venue: 'Etihad Arena' },
        { name: 'UFC Fight Night: Chiesa vs. Magny', date: '20 Jan 2021', venue: 'Etihad Arena' },
        { name: 'UFC Fight Night: Holloway vs. Kattar', date: '16 Jan 2021', venue: 'Etihad Arena' },
      ] },
      { year: '2020', items: [
        { name: 'UFC 254: Khabib vs. Gaethje', date: '24 Oct 2020', venue: 'du Forum (Fight Island)' },
        { name: 'UFC Fight Night: Ortega vs. The Korean Zombie', date: '17 Oct 2020', venue: 'du Forum (Fight Island)' },
        { name: 'UFC Fight Night: Moraes vs. Sandhagen', date: '10 Oct 2020', venue: 'du Forum (Fight Island)' },
        { name: 'UFC Fight Night: Holm vs. Aldana', date: '3 Oct 2020', venue: 'du Forum (Fight Island)' },
        { name: 'UFC 253: Adesanya vs. Costa', date: '26 Sep 2020', venue: 'du Forum (Fight Island)' },
        { name: 'UFC Fight Night: Whittaker vs. Till', date: '25 Jul 2020', venue: 'du Forum (Fight Island)' },
        { name: 'UFC Fight Night: Figueiredo vs. Benavidez 2', date: '18 Jul 2020', venue: 'du Forum (Fight Island)' },
        { name: 'UFC Fight Night: Kattar vs. Ige', date: '15 Jul 2020', venue: 'du Forum (Fight Island)' },
        { name: 'UFC 251: Usman vs. Masvidal', date: '11 Jul 2020', venue: 'du Forum (Fight Island)' },
      ] },
    ],
  },
  features: [
    ...
    { icon: 'Repeat', title: 'Recurring-Event Operating Model', desc: 'Same team, same runbook, same venue relationships year-over-year, operational learning compounded across six years.' },
  ],
  benefits: [
    { icon: 'Activity', t: 'Zero broadcast-affecting incidents', d: 'Across six consecutive years and 20 UFC fight cards on the UAE production LAN.' },
    ...
    { icon: 'Users', t: 'Same team, year on year', d: 'Engineers on site in 2026 were on site in 2020, operational continuity is the deliverable.' },
  ],
  process: [
  ...
  faqs: [
    { q: 'Have you been the IT partner for every UFC event in the UAE since 2020?', a: 'Yes. We have delivered all 20 UFC events held in the UAE since 2020, from UFC 251 on Fight Island in July 2020 through UFC Fight Night: Ankalaev vs. Guskov at Etihad Arena in July 2026. Same operating team carrying the institutional knowledge year over year.' },
...
subpages['world-tennis-league'] = {
  keyword: 'World Tennis League UAE IT Infrastructure',
  title: 'World Tennis League Dubai & Abu Dhabi: Arena Tennis IT Case Study | IP Care',
  metaDescription: 'How IP Care delivered arena WiFi, broadcast LAN, Hawk-Eye integration and on-court connectivity for the World Tennis League at Coca-Cola Arena Dubai (2022) and Etihad Arena Abu Dhabi (2023).',
  h1: 'World Tennis League (2022, 2023): Dubai & Abu Dhabi Arena IT Case Study',
  h1Accent: 'World Tennis League',
  hero: 'How IP Care delivered the arena network, broadcast LAN, Hawk-Eye officiating integration and on-court connectivity for the World Tennis League, back-to-back editions at Coca-Cola Arena Dubai and Etihad Arena Abu Dhabi, team exhibition format, ATP and WTA top-ten players on court.',
  icon: 'Trophy',
  overview: [
    'The World Tennis League is a relatively new exhibition tennis format, teams rather than individuals, top-ten ATP and WTA players, multi-day round-robin into finals, staged in indoor arena venues rather than the traditional tennis stadium environment. The 2022 inaugural edition was held at Coca-Cola Arena Dubai (19-24 December 2022) and the 2023 second edition moved to Etihad Arena on Yas Island, Abu Dhabi (21-24 December 2023), with IP Care delivering the IT operation for both.',
    'This case study walks through how indoor-arena-tennis IT differs from outdoor tennis tournament work and from non-tennis arena events, the Hawk-Eye integration story, and what carried across from year one in Dubai to year two in Abu Dhabi.',
    'What is technically different about indoor arena tennis',
    'Three things shape indoor-arena tennis IT relative to other event categories. The first is the temporary court installation. Neither Coca-Cola Arena nor Etihad Arena is natively a tennis venue. The court is installed for the duration of the event over the standard arena floor, which means the on-court connectivity, the Hawk-Eye camera positions, the chair umpire connectivity and the team-area integration all have to be installed and removed per edition. The cabling routing, the equipment placement and the on-court networking all sit on top of a non-permanent surface.',
    ...
    'The numbers',
    'Two consecutive editions, 2022 in Dubai and 2023 in Abu Dhabi. Approximately 15,000 spectators per session. Multiple team matches per evening across a six-day window in 2022 and a four-day window in 2023. Zero broadcast-impacting incidents across both editions. Zero Hawk-Eye-impacting incidents during live matches. The chair umpire and on-court officiating workflows operated cleanly across every match of both editions.',
    'Operational rhythm',
    'World Tennis League runs evening sessions across the event window, six days in 2022 and four in 2023. The IT operation maintains a steady state across the run, with pre-session validation each afternoon and continuous monitoring during the evening match windows. Pre-edition validation cycle was three days. T-3: full integration test across all networks plus a Hawk-Eye walkthrough with the broadcast and officiating teams. T-2: dress rehearsal of the chair umpire and team-area workflows. T-1: hard validation freeze and final broadcast handshake. Match day cadence: pre-session bridge meeting at 14:00, hard freeze at 16:00 for an 18:00 doors call, continuous monitoring through the evening sessions.',
    'Year-on-year evolution',
    'The 2022 Dubai edition was the inaugural delivery and required first-principles build of the Hawk-Eye integration network, the team-area connectivity workflow and the on-court cabling design. By 2023, those elements were documented and largely template-driven, which materially shortened the build window even though the event moved to a new venue, Etihad Arena in Abu Dhabi. The 2023 broadcast LAN was upgraded for slightly higher production resolution. The team-area integration was refined based on year-one feedback from the participating teams.',
  ...
  features: [
    { icon: 'Wifi', title: 'Arena WiFi 6', desc: '90+ access points across bowl, concourses, hospitality and back-of-house, engineered for evening-session crowd density across the round-robin and finals.' },
  ...
  faqs: [
    ...
    { q: 'How early do organisers need to engage?', a: 'For a first-edition delivery, six to eight weeks is comfortable. For a returning edition, three to four weeks is workable because most of the work is template-driven validation against the previous edition, and that held even when the 2023 edition moved from Coca-Cola Arena Dubai to Etihad Arena Abu Dhabi.' },
  ],
}
...
subpages['ya-salam-after-race-concert'] = {
  ...
  // Was 84 characters; ranks ~8.5, 0 clicks on 150 impressions. Searchers type
  // "yas salam" / "yasalam after-race concerts", so the title uses that spelling.
  title: 'Yasalam After-Race Concerts 2019-2024: Event IT | IP Care',
  metaDescription: 'Outdoor concert WiFi, PtP backhaul, RFID, CCTV and broadcast support for six consecutive years of the Yasalam After-Race Concerts on Yas Island, 2019 to 2024.',
...
subpages['euroleague-final-four-2025'] = {
  ...
  // Was 93 / 223 characters, both truncated; ranks ~9 with 0 clicks on 326 impressions.
  title: 'EuroLeague Final Four 2025 Abu Dhabi: Event IT | IP Care',
  metaDescription: 'Arena network, broadcast LAN, timing and statistics integration and CCTV for the first EuroLeague Final Four held outside Europe, Etihad Arena Abu Dhabi, May 2025.',
...
subpages['euroleague-supercup-2026'] = {
  keyword: 'EuroLeague SuperCup 2026 Abu Dhabi IT Infrastructure',
  title: 'EuroLeague Basketball SuperCup Abu Dhabi 2026: Event IT Case Study | IP Care',
  metaDescription: 'How IP Care delivered arena WiFi 6E, broadcast LAN, EuroLeague timing and statistics integration and NOC operations for the EuroLeague Basketball SuperCup at Etihad Arena, Abu Dhabi, 18-19 September 2026.',
  h1: 'EuroLeague Basketball SuperCup Abu Dhabi 2026: EuroLeague Returns to Etihad Arena',
  h1Accent: 'EuroLeague Basketball SuperCup',
  hero: 'How IP Care delivered the arena network, broadcast LAN, EuroLeague timing and statistics integration and venue NOC for the EuroLeague Basketball SuperCup, two days of elite club basketball at Etihad Arena, Abu Dhabi, September 2026.',
  icon: 'Trophy',
  overview: [
    'The EuroLeague Basketball SuperCup Abu Dhabi 2026 brought four leading clubs, Real Madrid, Olympiacos Piraeus, Fenerbahce Istanbul and Dubai Basketball, to Etihad Arena on Yas Island for a two-day tournament on 18 and 19 September 2026. The format was compact and demanding: two semifinals on the Friday, then the third-place game and the Final on the Saturday.',
    'For IP Care it was a return to a venue and a league we know well. Sixteen months earlier the same arena had hosted the Turkish Airlines EuroLeague Final Four 2025, the first Final Four ever held outside Europe, and IP Care delivered the IT operation for it. The SuperCup landed on that same foundation: the same arena estate, the same EuroLeague operating model and a delivery team that had already worked through the league\'s technical requirements at Etihad Arena.',
    'The line-up also carried a local angle. Dubai Basketball, the UAE\'s own club at the top level of European basketball, played in front of a home-region crowd alongside three of the most decorated clubs in the competition. That raised the profile of the weekend across the UAE and the wider GCC and added to the broadcast and press interest the venue had to support.',
    'The scope',
    'IP Care delivered the same four workstreams that defined the 2025 Final Four engagement.',
    'Arena WiFi 6E. High-density wireless across the bowl, concourses, hospitality areas and back-of-house, carrying spectators, teams, league staff, commercial partners and press on segmented networks with their own security and performance policies.',
    'The broadcast LAN. A dedicated network for the host broadcaster and rights-holder production teams working side by side in the arena, engineered for the multicast handling, latency and isolation that live international basketball broadcast requires.',
    'EuroLeague timing and statistics integration. The network connecting scoreboard control, the game and shot clocks, the on-floor statistics positions, broadcast graphics and the league-office data feed, validated against the EuroLeague operations specification.',
    'NOC operations. Continuous monitoring from the venue network operations centre across the build, both competition days and the post-event wrap, with joint escalation paths into EuroLeague operations and venue command.',
    'Why continuity with the 2025 Final Four mattered',
    'A two-day tournament leaves very little time to recover from a problem, so the work that matters happens before doors open. Because the EuroLeague-specific integration had already been built and validated at Etihad Arena for the 2025 Final Four, the SuperCup engagement did not start from a blank page. The team re-validated a known configuration against the league\'s current requirements rather than building a first-time integration under time pressure.',
    'The same applies to the working relationship. EuroLeague operations, the venue team and IP Care had already been through a full build week and competition weekend together. Walkthroughs, integration tests and sign-off followed a documented template, which shortened the pre-event cycle and cut risk out of the live window.',
    'Two days of competition',
    'Day one (Friday 18 September) carried both semifinals back-to-back, with the arena running continuously from doors to the second game\'s broadcast wrap. Day two (Saturday 19 September) carried the third-place game, the Final and the trophy presentation, the highest-pressure broadcast window of the weekend. Across both days the NOC held watch over the wireless estate, the broadcast LAN and the timing and statistics chain, and the delivery team stayed on site from pre-event validation through to post-event wrap.',
    'Why it matters for the UAE sports calendar',
    'The SuperCup puts EuroLeague club basketball back in Abu Dhabi a year after the Final Four and adds to a basketball calendar that already includes the NBA Abu Dhabi Games and the USA Basketball Showcase at the same arena. Each return engagement strengthens the case that the UAE can host international leagues to their own operating standard, and every edition leaves a more mature venue baseline for the next one.',
    'For IP Care the SuperCup is further proof of a model we apply across major events in the UAE: know the venue deeply, integrate early with the visiting league\'s operations team, and put the same experienced engineers back on the ground for every return engagement.',
  ],
  features: [
    { icon: 'Trophy', title: 'Four-Club Tournament Format', desc: 'Real Madrid, Olympiacos, Fenerbahce and Dubai Basketball. Two semifinals on day one, then the third-place game and the Final on day two.' },
    { icon: 'Wifi', title: 'Arena WiFi 6E', desc: 'High-density wireless across the bowl, concourses, hospitality and back-of-house, segmented for spectators, teams, league staff, partners and press.' },
    { icon: 'Radio', title: 'Broadcast LAN', desc: 'Dedicated network for the host broadcaster and rights-holder production teams, engineered for live international basketball broadcast.' },
    { icon: 'Clock', title: 'EuroLeague Timing & Statistics Integration', desc: 'Scoreboard, game and shot clocks, on-floor statistics, broadcast graphics and league-office data feed, validated to the EuroLeague operations specification.' },
    { icon: 'MonitorCheck', title: 'NOC Operations', desc: 'Continuous monitoring across build, both competition days and wrap, with joint escalation into EuroLeague operations and venue command.' },
    { icon: 'Building2', title: 'Continuity from the 2025 Final Four', desc: 'Same venue, same EuroLeague operating model and a delivery team that had already built and validated the league integration at Etihad Arena.' },
  ],
  benefits: [
    { icon: 'ShieldCheck', t: 'Proven EuroLeague integration', d: 'The timing, statistics and broadcast integration was re-validated from the 2025 Final Four baseline rather than built from scratch.' },
    { icon: 'TrendingDown', t: 'Shorter pre-event cycle', d: 'A documented walkthrough, test and sign-off template from the previous EuroLeague engagement at the same venue.' },
    { icon: 'Users', t: 'Experienced on-site team', d: 'Engineers who know Etihad Arena and the EuroLeague operating model, on site from pre-event validation to post-event wrap.' },
    { icon: 'Activity', t: 'Continuous NOC coverage', d: 'Wireless, broadcast LAN and the timing and statistics chain monitored throughout both competition days.' },
  ],
  process: [
    { n: '01', t: 'Pre-event', d: 'Joint walkthroughs with EuroLeague operations, re-validation of the broadcast LAN and the timing and statistics integration against the league specification.' },
    { n: '02', t: 'Build week', d: 'Arena network, broadcast LAN and press connectivity brought up, end-to-end integration testing and sign-off ahead of the tournament.' },
    { n: '03', t: 'Day 1 (Fri 18 Sep)', d: 'Both semifinals back-to-back, with continuous NOC operation from doors to broadcast wrap.' },
    { n: '04', t: 'Day 2 (Sat 19 Sep)', d: 'Third-place game, the Final and the trophy presentation. Full broadcast coverage, statistics archive and post-event wrap.' },
  ],
  industries: ['European Club Basketball', 'EuroLeague Operations', 'International Sports Broadcast', 'Arena WiFi & Network Operations', 'League-Standards Arena IT', 'UAE Major Events'],
  faqs: [
    { q: 'When and where was the EuroLeague Basketball SuperCup Abu Dhabi 2026?', a: 'At Etihad Arena on Yas Island, Abu Dhabi, on 18 and 19 September 2026. The two semifinals were played on the Friday, with the third-place game and the Final on the Saturday.' },
    { q: 'Which clubs took part?', a: 'Real Madrid, Olympiacos Piraeus, Fenerbahce Istanbul and Dubai Basketball.' },
    { q: 'What did IP Care deliver?', a: 'Arena WiFi 6E, the broadcast LAN for the host broadcaster and rights-holder production teams, EuroLeague timing and statistics integration, and NOC operations across the build, both competition days and the post-event wrap.' },
    { q: 'How did the 2025 EuroLeague Final Four help?', a: 'IP Care delivered the IT operation for the 2025 Final Four at the same arena. The EuroLeague-specific integration, the operating template with EuroLeague operations and the delivery team all carried across, so the SuperCup built on a validated baseline instead of starting from scratch.' },
    { q: 'Can IP Care deliver IT for other international sports events in the UAE and GCC?', a: 'Yes. IP Care delivers event IT infrastructure for international sports, concerts and national events across the UAE, including the FIFA Club World Cup, UFC, NBA Abu Dhabi Games and the EuroLeague Final Four. Contact our Event IT team to discuss your venue and timeline.' },
  ],
}
