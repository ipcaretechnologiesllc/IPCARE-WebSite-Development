...
export const events = [
  ...
  {
    slug: 'abu-dhabi-pedal-master',
    name: 'Abu Dhabi Pedal Master',
    year: '2023',
    location: 'Hudayriat Island, Abu Dhabi',
    region: 'UAE Events',
    category: 'Sports',
    tech: 'Course-side WiFi, PtP microwave links, timing-system network, CCTV',
    stats: { users: 'World Pedal Tour event', sites: 'Hudayriat cycle track', duration: '3 days' },
...
subpages['abu-dhabi-pedal-master'] = {
  keyword: 'Abu Dhabi Pedal Master Cycling IT Infrastructure',
  title: 'Abu Dhabi Pedal Master 2023 — World Pedal Tour Cycling IT Case Study | IP Care',
  metaDescription: 'How IP Care delivered course-side WiFi, point-to-point microwave links, timing-system network and CCTV for the Abu Dhabi Pedal Master at Hudayriat Island — a World Pedal Tour cycling event.',
  h1: 'Abu Dhabi Pedal Master 2023 — Course-Side Cycling Event IT Case Study',
  hero: 'How IP Care delivered the course-side network, point-to-point microwave backhaul, mobile timing infrastructure and CCTV for the Abu Dhabi Pedal Master at Hudayriat Island — a World Pedal Tour event on a long-distance outdoor cycling course.',
  icon: 'Bike',
  overview: [
  ...
  features: [
    { icon: 'Wifi', title: 'Course-Side Outdoor WiFi', desc: '30+ outdoor-rated access points distributed across start, finish, intermediate timing points and spectator concentrations.' },
    { icon: 'Radio', title: 'Chained PtP Microwave Backhaul', desc: 'Multiple Cambium and Ubiquiti point-to-point microwave links connecting all course-side positions to the central NOC.' },
    { icon: 'Clock', title: 'Mobile Timing-System Integration', desc: 'Dedicated network integrating start-line, intermediate splits and finish-line timing equipment with sub-second precision.' },
    { icon: 'Truck', title: 'Support Vehicle Integration', desc: 'Mobile networking equipment travelling with team support, neutral support and broadcast motorbikes.' },
    { icon: 'MonitorCheck', title: 'Central NOC at Finish Line', desc: 'Race-window monitoring across all distributed positions with broadcast-grade uplink to rights-holder.' },
    { icon: 'Users', title: 'Distributed Engineering Team', desc: 'Mobile engineering teams covering sections of the course with pre-staged spare equipment at each section.' },
  ],
  benefits: [
    { icon: 'Activity', t: 'Zero race-impacting incidents', d: 'Distributed-course timing and broadcast delivered across the full race window.' },
    { icon: 'Map', t: 'Full-course coverage', d: 'Connectivity at every required position from start through finish across the long course.' },
    { icon: 'Clock', t: 'Sub-second timing precision', d: 'Race-result and broadcast timing delivered to cycling event precision standards.' },
    { icon: 'Bike', t: 'World Pedal Tour delivered', d: 'IT infrastructure for the World Pedal Tour event delivered at Hudayriat Island to the tour technical envelope.' },
  ],
  process: [
    { n: '01', t: 'T-3', d: 'Course-side infrastructure deployment, PtP backhaul chain commissioning.' },
    { n: '02', t: 'T-2', d: 'Full integration test across all distributed positions, timing-system integration validation.' },
    { n: '03', t: 'T-1', d: 'Dress rehearsal of incident response across distributed footprint; hard validation freeze.' },
    { n: '04', t: 'Race Day', d: 'Monitoring posture across full course from race start through last finisher and broadcast wrap.' },
    { n: '05', t: 'Post-Event', d: 'Distributed teardown across the course, evidence consolidation, formal report, runbook updates for future distributed-event work.' },
  ],
  industries: ['Cycling Events', 'Distributed-Course Sports', 'Outdoor Endurance Sports', 'Long-Distance Race Operations', 'Broadcast Motorbike Integration', 'Mobile Timing Systems'],
  faqs: [
    { q: 'How is distributed cycling event IT different from venue-based event IT?', a: 'The infrastructure is spread across the full course rather than anchored at a single venue. Point-to-point microwave backhaul replaces fibre as the primary backhaul where carrier connectivity is unavailable. Mobile engineering teams cover sections of the course rather than being centrally located. Timing-system integration operates across kilometres of distributed infrastructure with sub-second precision.' },
    { q: 'What is the PtP backhaul chain?', a: 'Multiple point-to-point microwave links connecting all course-side positions back to the central NOC. Each intermediate position acts as both a service edge and a relay node. The chain is the architectural critical path of a distributed cycling event, with redundant paths where geographically feasible and pre-staged spare equipment at each position.' },
    { q: 'How is the timing system integrated?', a: 'A dedicated mobile timing-system network integrates start-line, intermediate splits and finish-line timing equipment with the race-result and broadcast workflows. The integration delivers sub-second precision across the full course and operates continuously through the race window.' },
    { q: 'How do you handle failures at intermediate positions during the race?', a: 'Mobile engineering teams covering sections of the course with pre-staged spare equipment at each section. The operational decision framework prioritises remediation that can happen quickly over remediation that is technically perfect but operationally slow. The architectural redundancy in the PtP chain is the first line of defence; mobile remediation is the second.' },
    { q: 'Can this model deliver for other distributed-course events?', a: 'Yes — the same architecture and operating model is portable to other distributed-course sports including marathons, triathlons and motorsport, with appropriate sport-specific timing-system integration. The cycling-event experience from the Pedal Master is the foundation for this capability in the region.' },
    { q: 'How early do race organisers need to engage?', a: 'For a first-edition delivery on a course we have not previously worked on, six to eight weeks is comfortable — much of that time is course-side site survey and PtP path planning. For a returning edition on the same course, three to four weeks is workable because the PtP design and the position planning carry forward.' },
  ],
}
