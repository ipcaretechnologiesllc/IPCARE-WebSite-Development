...
subpages['usa-basketball-2024'] = {
  ...
  hero: 'How IP Care delivered enterprise-grade arena WiFi 6E, broadcast LAN, multi-rights-holder production support and NOC operations for the USA Basketball international showcase at Etihad Arena, Yas Island, Abu Dhabi — October 2024.',
  icon: 'Trophy',
  overview: [
  ...
  faqs: [
    { q: 'What WiFi standard did IP Care deploy at Etihad Arena?', a: 'WiFi 6E — the current generation of enterprise wireless, delivering higher throughput, lower latency and better performance at high device density than WiFi 6 or WiFi 5. At arena scale with thousands of concurrent users, WiFi 6E\'s use of the 6 GHz band reduces co-channel interference and improves per-device throughput significantly.' },
