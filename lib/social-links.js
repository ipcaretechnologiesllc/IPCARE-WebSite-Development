...
// Abu Dhabi GBP place ID. It encodes the same CID as googleBusinessProfile above.
// Links and embeds that point at the listing, not at raw coordinates, are what Google
// counts as "directions on your website" for the Business Profile. A coordinate pin is
// unnamed and isn't tied to the listing.
export const GBP_PLACE_ID = 'ChIJM45aieBnXj4R5rCSBYM5aPU'
export const GBP_DIRECTIONS_URL =
  `https://www.google.com/maps/dir/?api=1&destination=IP+CARE+Technologies+L.L.C&destination_place_id=${GBP_PLACE_ID}`
// The embed must use ?cid=. It renders the named listing card with its rating.
// `q=place_id:...` does not resolve in the keyless embed: tested 2026-09-25, it showed
// a zoomed-out world map.
export const GBP_MAP_EMBED_URL =
  'https://maps.google.com/maps?cid=17683447171767251174&z=16&output=embed'
