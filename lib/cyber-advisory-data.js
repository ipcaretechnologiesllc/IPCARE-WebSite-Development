...
export const kbArticles = [
  ...
  },
  {
    ...
    // Ranks ~8.8 with 0.4% CTR; the visible query is "fortianalyzer vs fortisiem",
    // which is what the body actually answers.
    seoTitle: 'FortiAnalyzer vs FortiSIEM: Roles and Integration | IP Care',
    pillar: { href: '/cybersecurity-advisory/security-automation', label: 'Security Automation' },
    keyTakeaways: [
