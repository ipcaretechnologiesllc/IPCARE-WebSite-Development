...
export const platforms = [
  ...
  { name: 'Prisma Access', spec: 'SASE cloud delivery — remote access and branch security', badge: 'In Active Practice', advisor: 'Tanveer Bhatti' },
  { name: 'Prisma SD-WAN', spec: 'Software-defined WAN with application-defined policies', badge: 'In Active Practice', advisor: 'Tanveer Bhatti' },
  { name: 'CASB', spec: 'Cloud access security broker for SaaS visibility and data protection', badge: 'In Active Practice', advisor: 'Tanveer Bhatti' },
  { name: 'SWG', spec: 'Secure Web Gateway — web traffic inspection and filtering', badge: 'In Active Practice', advisor: 'Tanveer Bhatti' },
  { name: 'ZTNA', spec: 'Zero Trust Network Access — identity-based application access', badge: 'In Active Practice', advisor: 'Tanveer Bhatti' },
  { name: 'AlgoSec', spec: 'Firewall policy management and security change automation', badge: 'In Active Practice', advisor: 'Tanveer Bhatti' },
]
...
export const services = [
  ...
  {
    title: 'Prisma Access Implementation',
    desc: 'End-to-end Prisma Access SASE deployment — GlobalProtect, remote access, and branch security transformation.',
    icon: 'Cloud',
  },
  {
    title: 'CASB & Cloud App Security',
    desc: 'Visibility and control over cloud application usage, shadow IT, and sensitive data across enterprise SaaS environments.',
    icon: 'Shield',
  },
  {
    title: 'Secure Web Gateway (SWG)',
    desc: 'Web traffic inspection, URL filtering, SSL decryption, and threat protection for distributed workforces.',
    icon: 'Globe',
  },
  {
    title: 'Data Loss Prevention (DLP)',
    desc: 'Comprehensive data protection across web, cloud, email, and endpoint channels preventing sensitive data exfiltration.',
    icon: 'Lock',
  },
  {
    title: 'SD-WAN Transformation',
    desc: 'Prisma SD-WAN deployment replacing legacy MPLS with application-defined intelligent routing and full visibility.',
    icon: 'Network',
  },
]
...
export const subpages = {
  ...
  'executive-advisory': {
    ...
    features: [
      ...
      { icon: 'FileCheck', title: 'Regulatory Readiness', desc: 'OSFI B-13, NESA, UAE PDPL, ADHICS, CBUAE, SOC 2 and ISO 27001 guidance.' },
    ],
    benefits: [
      ...
      { icon: 'Clock', t: 'On-demand access', d: 'Advisory retainer with response within one business day.' },
    ],
    process: [
