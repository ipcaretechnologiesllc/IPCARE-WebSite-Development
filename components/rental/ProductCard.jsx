...
export default function ProductCard({ product, categorySlug }) {
  ...
  return (
    <div className="glass-card overflow-hidden group flex flex-col h-full">
      <Link href={`/rental/${categorySlug}/${product.slug}`} className="relative block h-60 overflow-hidden" style={{ background: 'rgba(10,20,55,0.95)' }}>
        ...
        <div className="absolute inset-0" style={{ background: 'linear-gradient(180deg, transparent 60%, rgba(7,16,42,0.75) 100%)' }}/>
