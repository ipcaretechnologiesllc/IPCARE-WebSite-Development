...
// ─── AnimatedNavItem ──────────────────────────────────────────────────────────
// Wraps a desktop nav link with 3D flip + radial gradient glow.
//
// Props:
...
export function AnimatedNavItem({ gradient, frontContent, backContent, className }) {
  return (
    <motion.div
    ...
    >
      ...
      />
      {/* Front face — rotates away on hover */}
      <motion.div
...
// ─── HoverGradientNavBar ──────────────────────────────────────────────────────
// Original demo component — a fixed bottom floating pill nav bar.
// Kept for reference; not used by the main site header.
...
const menuItems = [
  ...
  { icon: <BarChart3 className="h-5 w-5" />, label: 'Analytics', href: '#', gradient: 'radial-gradient(circle, rgba(34,197,94,0.15) 0%, rgba(22,163,74,0.06) 50%, rgba(34,197,94,0) 100%)',   iconColor: 'group-hover:text-green-500 dark:group-hover:text-green-400' },
