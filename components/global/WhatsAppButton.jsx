...
export default function WhatsAppButton() {
  const msg = encodeURIComponent("Hi, I'm interested in IP Care Technologies services.")
  return (
    <a
      href={`https://wa.me/971506828290?text=${msg}`}
      target="_blank"
      ...
      onMouseEnter={(e) => {
        ...
        const tip = e.currentTarget.querySelector('.wa-tooltip')
    ...
    >
      {/* Simple-icons style WhatsApp glyph */}
      <svg viewBox="0 0 24 24" width="28" height="28" aria-hidden="true" fill="#ffffff">
