              ...
              {filtered.map((a, i) => (
                <article key={a.title} className="glass-premium p-6 reveal group cursor-pointer" style={{ transitionDelay: `${(i % 6) * 50}ms` }}>
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-white/5">
                    ...
                    <span className="inline-flex items-center gap-1 text-[#1B6CA8] text-xs font-semibold group-hover:gap-2 transition-all">Read Article <Icons.ArrowRight size={12}/></span>
                  </div>
                </article>
              ))}
            </div>
