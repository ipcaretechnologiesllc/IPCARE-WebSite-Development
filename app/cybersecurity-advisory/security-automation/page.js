...
export default function SecurityAutomationPage() {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: pageData.h1, item: (process.env.NEXT_PUBLIC_BASE_URL || 'https://ipcare.ae') + '/cybersecurity-advisory/security-automation' },
    ],
  }
  ...
  const serviceSchema = {
    ...
    url: (process.env.NEXT_PUBLIC_BASE_URL || 'https://ipcare.ae') + '/cybersecurity-advisory/security-automation',
  }
