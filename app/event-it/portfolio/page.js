...
export default function EventPortfolioPage() {
  ...
  const events = [
    ...
    { id: 8, name: 'Abu Dhabi Padel Master', location: 'Hudayriat Island, Abu Dhabi', year: '2023', services: 'Multi-court WiFi, Broadcast LAN, Court-side connectivity, Ball-tracking integration', tech: 'HPE Aruba, Cisco', category: ['Sports', 'WiFi Deployments'] },
