...
export default function EventPortfolioPage() {
  ...
  const events = [
    ...
    { id: 2, name: 'UFC Events in UAE (2020-2026)', slug: 'ufc-uae', location: 'Yas Island, Abu Dhabi', year: '2020-2026', services: 'Arena WiFi, Production LAN, Live streaming', tech: 'Cisco Meraki, Palo Alto', category: ['Sports', 'WiFi Deployments'], img: '/events/ufc-uae.webp' },
    ...
    { id: 6, name: 'World Tennis League (2022, 2023)', slug: 'world-tennis-league', location: 'Coca-Cola Arena, Dubai & Etihad Arena, Abu Dhabi', year: '2022, 2023', services: 'Arena WiFi, Hawk-Eye integration', tech: 'Cisco Meraki, HPE Aruba', category: ['Sports', 'WiFi Deployments'], img: '/events/world-tennis-league.webp' },
