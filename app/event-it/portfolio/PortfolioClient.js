...
export default function EventPortfolioPage() {
  ...
  const events = [
    { id: 1, name: 'FIFA Club World Cup 2022', slug: 'fifa-club-world-cup', location: 'Abu Dhabi, UAE', year: '2022', services: 'High-density WiFi, Temporary data centre, Tournament SOC', tech: 'HPE Aruba, Cisco', category: ['Sports', 'WiFi Deployments', 'CCTV & Security'], img: '/events/fifa-club-world-cup.webp', imgPos: 'center 40%' },
    { id: 2, name: 'UFC Events in UAE (2020-2026)', slug: 'ufc-uae', location: 'Yas Island, Abu Dhabi', year: '2020-2026', services: 'Arena WiFi, Production LAN, Live streaming', tech: 'Cisco Meraki, Palo Alto', category: ['Sports', 'WiFi Deployments'], img: '/events/ufc-uae.webp', imgPos: 'center 55%' },
    { id: 3, name: 'FINA World Swimming Championship', slug: 'fina-world-swimming-championship', location: 'Etihad Arena, Abu Dhabi', year: '2021', services: 'Aquatic-venue WiFi, Broadcast LAN', tech: 'HPE Aruba, Cisco', category: ['Sports', 'WiFi Deployments'], img: '/events/fina-world-swimming-championship.webp', imgPos: 'center 50%' },
    { id: 4, name: 'NBA Abu Dhabi Games (2022-2025)', slug: 'nba-abu-dhabi-games', location: 'Etihad Arena, Abu Dhabi', year: '2022, 2023, 2024, 2025', services: 'Arena WiFi 6E, NOC operations', tech: 'HPE Aruba, Ruckus', category: ['Sports', 'WiFi Deployments'], img: '/events/nba-abu-dhabi-games.webp', imgPos: 'center 30%' },
    { id: 15, name: 'Turkish Airlines EuroLeague Final Four 2025', slug: 'euroleague-final-four-2025', location: 'Etihad Arena, Abu Dhabi', year: '23-25 May 2025', services: 'EuroLeague broadcast LAN, multi-language commentary, timing & statistics integration', tech: 'HPE Aruba, Cisco Catalyst, Palo Alto', category: ['Sports', 'WiFi Deployments'], img: '/events/euroleague-final-four-2025.webp', imgPos: 'center 70%' },
    { id: 18, name: 'EuroLeague Basketball SuperCup Abu Dhabi 2026', slug: 'euroleague-supercup-2026', location: 'Etihad Arena, Abu Dhabi', year: '18-19 Sep 2026', services: 'Arena WiFi 6E, broadcast LAN, EuroLeague timing & statistics integration, NOC operations', tech: 'HPE Aruba, Cisco Catalyst, Palo Alto', category: ['Sports', 'WiFi Deployments'], img: '/events/euroleague-supercup-2026-team.webp' },
    { id: 5, name: 'WBA Light Heavyweight World Championship', slug: 'wba-light-heavyweight-championship', location: 'Etihad Arena, Abu Dhabi', year: '2022', services: 'Arena WiFi, Broadcast uplinks', tech: 'HPE Aruba, Cisco', category: ['Sports', 'WiFi Deployments'], img: '/events/wba-light-heavyweight-championship.webp', imgPos: 'center 65%' },
    { id: 6, name: 'World Tennis League (2022, 2023)', slug: 'world-tennis-league', location: 'Coca-Cola Arena, Dubai & Etihad Arena, Abu Dhabi', year: '2022, 2023', services: 'Arena WiFi, Hawk-Eye integration', tech: 'Cisco Meraki, HPE Aruba', category: ['Sports', 'WiFi Deployments'], img: '/events/world-tennis-league.webp', imgPos: 'center 55%' },
    { id: 7, name: 'Mubadala Abu Dhabi Open', slug: 'mubadala-abu-dhabi-open', location: 'Zayed Sports City', year: 'Annual', services: 'Outdoor venue WiFi, Timing-system network', tech: 'HPE Aruba, Fluke', category: ['Sports', 'WiFi Deployments'], img: '/events/mubadala-abu-dhabi-open.webp', imgPos: 'center 45%' },
    { id: 8, name: 'Abu Dhabi Padel Master', slug: 'abu-dhabi-padel-master', location: 'Hudayriat Island, Abu Dhabi', year: '2023', services: 'Multi-court WiFi, Broadcast LAN, Court-side connectivity, Ball-tracking integration', tech: 'HPE Aruba, Cisco', category: ['Sports', 'WiFi Deployments'], img: '/events/abu-dhabi-padel-master.webp', imgPos: 'center 40%' },
    { id: 9, name: 'UAE Official National Day: 48th Edition', slug: 'uae-national-day', location: 'Zayed Sports City + nationwide venues', year: '2019', services: 'Multi-venue WiFi mesh, government-grade CCTV, command-centre integration, federal coordination', tech: 'HPE Aruba, Hikvision, Cisco', category: ['National', 'WiFi Deployments', 'CCTV & Security'], img: '/events/uae-national-day-48th.webp', imgPos: 'center 55%', video: 'https://www.facebook.com/plugins/video.php?href=https%3A%2F%2Fwww.facebook.com%2Freel%2F1002301510156090%2F&show_text=false&width=800', videoLabel: 'Watch 48th National Day' },
    { id: 16, name: 'UAE Official National Day: 49th Edition', slug: 'uae-national-day', location: 'Al Jubail Mangrove Park, Abu Dhabi', year: '2020', services: 'Multi-venue WiFi, broadcast LAN, government-grade CCTV, command-centre integration', tech: 'HPE Aruba, Hikvision, Cisco', category: ['National', 'WiFi Deployments', 'CCTV & Security'], img: '/events/uae-national-day-49th.webp', imgPos: 'center 70%', video: 'https://www.youtube.com/embed/3zioTRC9Cc8', videoLabel: 'Watch 49th National Day' },
    { id: 17, name: 'USA Basketball Showcase 2024', location: 'Etihad Arena, Abu Dhabi', year: '2024', services: 'Arena WiFi 6E, broadcast LAN, media-centre connectivity, NOC operations, digital signage', tech: 'HPE Aruba, Cisco, Palo Alto', category: ['Sports', 'WiFi Deployments'], img: '/events/usa-basketball-2024.webp', imgPos: 'center 35%' },
    { id: 10, name: 'Ya Salam After Race Concert (2019-2024)', slug: 'ya-salam-after-race-concert', location: 'Yas Island, Abu Dhabi', year: '2019-2024', services: 'Outdoor festival WiFi, PtP backhaul, RFID', tech: 'HPE Aruba, Ruckus', category: ['Concerts', 'WiFi Deployments'], img: '/events/ya-salam-after-race-concert.webp', imgPos: 'center 50%' },
    { id: 11, name: 'IIFA Awards (2022-2024)', slug: 'iifa-awards', location: 'Yas Island, Abu Dhabi', year: '2022, 2023, 2024', services: 'Arena WiFi, Broadcast LAN, Press centre', tech: 'HPE Aruba, Cisco', category: ['Concerts', 'WiFi Deployments'], img: '/events/iifa-awards.webp', imgPos: 'center 20%' },
    ...
    { id: 13, name: 'Saadiyat Nights (2024, 2025)', slug: 'saadiyat-nights', location: 'Saadiyat Island, Abu Dhabi', year: '2024, 2025', services: 'Open-air WiFi, PtP microwave, CCTV', tech: 'HPE Aruba, Hikvision', category: ['Concerts', 'WiFi Deployments', 'CCTV & Security'], img: '/events/saadiyat-nights.webp', imgPos: 'center 65%' },
    { id: 14, name: 'Coldplay World Tour', slug: 'coldplay-world-tour', location: 'Zayed Sports City, Abu Dhabi', year: '2024', services: 'Outdoor 60K-attendee WiFi, RFID backhaul', tech: 'HPE Aruba, Fluke', category: ['Concerts', 'WiFi Deployments'], img: '/events/coldplay-world-tour.webp', imgPos: 'center 50%' },
  ]
                    ...
                    <div className="aspect-[4/3] relative overflow-hidden" style={{ background: 'linear-gradient(135deg, rgba(232,119,34,0.15) 0%, rgba(27,108,168,0.15) 100%)' }}>
                      {event.img ? (
                        <img
                          ...
                          loading="lazy"
                          decoding="async"
                          style={{ objectPosition: event.imgPos || 'center' }}
