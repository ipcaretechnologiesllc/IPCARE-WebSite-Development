...
export default function EventITPage() {
  ...
  const events = [
    ...
    { slug: 'euroleague-final-four-2025', name: 'EuroLeague Final Four 2025', location: 'Etihad Arena, Abu Dhabi', year: '23–25 May 2025', tech: 'EuroLeague broadcast LAN, multi-language commentary, timing & statistics integration, NOC ops — first Final Four held outside Europe', category: 'Sports' },
