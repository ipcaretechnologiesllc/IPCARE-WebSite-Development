...
const HERO_SLIDES = [
  ...
  },
  {
    ...
    icon: Server,
    headline: 'Enterprise IT Solutions and ',
    headlineAccent: 'Services That Deliver',
    description: 'From strategy and implementation to 24/7 managed operations, IP Care covers the complete IT stack for enterprise, government, and fast-growth organisations. Trusted since 2003.',
  ...
  },
  {
    ...
    icon: Lock,
    headline: 'Enterprise Cybersecurity You Can Rely On',
  ...
  },
  {
    ...
    icon: ShieldCheck,
    headline: 'Physical Security and Infrastructure ',
  ...
  },
  {
    ...
    icon: Network,
    headline: 'Enterprise IT Equipment, ',
